...
int main(void)
{
    ...
    bot_defender.challengeNewcomer("Daly");
    bot_defender.challengeNewcomer("Daly");
    std::cout << "_________________________THIS IS CLAPTRAP___________________________" << std::endl;
    ClapTrap clap;
    clap.meleeAttack("Shon");
    std::cout << "_________________________THIS IS NINJA___________________________" << std::endl;
    NinjaTrap ninja("NARUTO");
    NinjaTrap saske("SASKEEEEE");
    ninja.ninjaShoebox(ausos);
    ninja.ninjaShoebox(bot_defender2);
    ninja.ninjaShoebox(clap);
    ninja.ninjaShoebox(saske);
    std::cout << "_________________________THIS IS BOSS___________________________" << std::endl;
    SuperTrap sup("JOE");
